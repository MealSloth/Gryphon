...
public class MealConfirmation2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavButtonFavorites.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent(MealConfirmation2Activity.this, FavoritesMealsActivity.class);
                startActivity(i);
            }
        });
        ...
        mNavButtonHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent(MealConfirmation2Activity.this, MainActivity.class);
                startActivity(i);
            }
        });
        ...
        mNavButtonProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent(MealConfirmation2Activity.this, ProfileActivity.class);
                startActivity(i);
            }
        });
