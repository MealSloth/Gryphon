...
public class MealConfirmation3Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mNavButtonFavorites.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent(MealConfirmation3Activity.this, FavoritesMealsActivity.class);
                startActivity(i);
            }
        });
        ...
        mNavButtonHome.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent(MealConfirmation3Activity.this, MainActivity.class);
                startActivity(i);
            }
        });
        ...
        mNavButtonProfile.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v)
            {
                Intent i = new Intent(MealConfirmation3Activity.this, ProfileActivity.class);
                startActivity(i);
            }
        });
